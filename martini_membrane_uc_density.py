...
parser.add_argument('-j', dest='electron_mass_json', type=str, default='cg_electron.json',help='input json file with CG beads mass or number of electron generated using martini_bead_electron_mass_assigner.py')
...
def calculate_density (u, cg_electron_mass, group="C3A", skip=3, dz=1, begin_frame=0, end_frame=-1, z_lim=40, q0=0.083, N=4, M=4, undulation_correct=1):
...
if output_filename is None:
    dens_type = cg_electron_mass ["dens_type"]
    if undulation_correct: 
